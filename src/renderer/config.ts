import type { SkillsMcpAssistantHelpersConfig } from '../shared/skillsMcpAssistantConfig';
import { createDefaultSkillsMcpAssistantByRole } from '../shared/skillsMcpAssistantConfig';
import {
  createDefaultNativeCapabilitiesConfig,
...
export const defaultConfig: AppConfig = {
  ...
  nativeCapabilities: createDefaultNativeCapabilitiesConfig(),
  app: {
    port: 3000,
