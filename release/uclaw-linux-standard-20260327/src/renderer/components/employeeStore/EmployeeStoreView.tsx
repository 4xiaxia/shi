...
const EmployeeStoreView: React.FC<EmployeeStoreViewProps> = ({
  ...
  return (
    <div className="flex-1 flex flex-col dark:bg-claude-darkBg bg-claude-bg h-full">
      <div className="draggable flex h-12 items-center justify-between px-3 sm:px-4 border-b dark:border-claude-darkBorder/70 border-claude-border/60 shrink-0 bg-gradient-pearl-header backdrop-blur-xl">
