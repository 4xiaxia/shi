...
> 最后更新: 2026-03-25 | 本文件负责项目架构宪法与边界定义；`docs/REPAIR_CHECKLIST_2026-03-25_06-07.md` 负责当期修复台账。其他 docs/ 多为专题记录或历史沉淀。
>
...
- 项目家风与做事礼仪: `docs/HOUSE_STYLE.md`
- 禁动标记与误伤防护: `docs/NO_TOUCH_MARKERS.md`
- 每日记忆链路验收: `docs/DAILY_MEMORY_ACCEPTANCE.md`
- 当前修复台账与核查结论: `docs/REPAIR_CHECKLIST_2026-03-25_06-07.md`
- 后续涉及安装、运行时、依赖补齐、用户电脑写入策略时，以该文档优先
